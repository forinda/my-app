...
export type OrgProjectCategoryType = {
  id: number;
  name: string;
  description: string;
  created_by: number;
...
export type OrgProjectType = {
  ...
  updated_at: string;
  deleted_at: null;
  project_category: OrgProjectCategoryType;
};
...
export type FetchOrganizationMembersResponseType = ResponseObject<
  OrganizationMemberType[]
>;
export type FetchOrganizationResponseType = ResponseObject<
  SelectOrganizationInterface[]
>;
export type FetchDepartmentResponseType = ResponseObject<DepartmentType[]>;
export type FetchOrganizationDesignationResponseType = ResponseObject<
  OrganizationDesignationType[]
>;
export type FetchDepartmentTitleResponseType = ResponseObject<
  DepartmentTitleType[]
>;
...
export type FetchOrgProjectCategoryResponseType = ResponseObject<
  OrgProjectCategoryType[]
>;
export type FetchOrgProjectsResponseType = ResponseObject<OrgProjectType[]>;
