...
const { currentOrg, refresh, setCurrentOrganization } =
  await useOrganizations();
...
<template>
  <div class="flex h-screen bg-gray-100">
    <!-- Sidebar -->
    <org-dashboard-sidebar :isSidebarOpen="isSidebarOpen" :org-id="orgId" :route-path="currentRoute"
